 ...
 *  empty, and the empty `buildings_texture_folder` tag is dropped too (confirmed optional
 *  on the forum, 2026-07-08). If in-sim testing shows the sim wants them present, add them here. */
