...
const pct: PctApi = {
  ...
  listThumbnails: () => ipcRenderer.invoke("pct:listThumbnails"),
  getThumbnail: (name) => ipcRenderer.invoke("pct:getThumbnail", name),
  saveObjectPhoto: (name) => ipcRenderer.invoke("pct:saveObjectPhoto", name),
  deleteObjectPhoto: (name) => ipcRenderer.invoke("pct:deleteObjectPhoto", name),
  openPhotosDir: () => ipcRenderer.invoke("pct:openPhotosDir"),
  getFootprints: () => ipcRenderer.invoke("pct:getFootprints"),
  setFootprint: (key, override) => ipcRenderer.invoke("pct:setFootprint", key, override),
  importFootprints: () => ipcRenderer.invoke("pct:importFootprints"),
  exportFootprints: () => ipcRenderer.invoke("pct:exportFootprints"),
  ...
  planXrefRegistration: () => ipcRenderer.invoke("pct:planXrefRegistration"),
  registerXref: () => ipcRenderer.invoke("pct:registerXref"),
  ...
  icaoStatus: (icao) => ipcRenderer.invoke("pct:icaoStatus", icao),
